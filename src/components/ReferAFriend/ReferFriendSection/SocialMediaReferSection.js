    ...
    <Row>
      <Col className="text-center">
        <ul className="social__list">
          <li>
            <img src={Wechat} className="refer__social" />
          </li>
          <li>
            <img src={instagram} className="refer__social" />
          </li>
          <li>
            <img src={whatsapp} className="refer__social" />
          </li>
          <li>
            <img src={twitter} className="refer__social" />
          </li>
          <li>
            <img src={fb} className="refer__social" />
          </li>
          <li>
            <img src={linkedIn} className="refer__social" />
          </li>
          <li>
            <img src={pinterest} className="refer__social" />
          </li>
        </ul>
      </Col>
    </Row>
...
export default SocialMediaReferSection;
